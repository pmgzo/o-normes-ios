...
class ElevatorStageDelegate: PRegulationCheckStageDelegate {
    ...
    override init(config: ERP_Config, coordinator: UJCoordinator) {  // build its stage array
        ...
        self.steps.append(GenericRegulationView(title: "Ascenseur", content: [
            RegulationCheckField(key: "ascenseurmaincourante", type: TypeField.string, text: "La main courante doit être comprise entre 87.5cm et 92.5cm", optional: false)], id: "ascenseur"))
        self.steps.append(GenericRegulationView(title: "Ascenseur", content: [
            RegulationCheckField(key: "ascenseurcatune", type: TypeField.bool, text: "Ascenseur type 1: 1,25m x 1m avec un passage libre de 80cm", optional: false)], id: "ascenseur"))
        self.steps.append(GenericRegulationView(title: "Ascenseur", content: [
